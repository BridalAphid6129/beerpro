...
public class FridgeActivity extends AppCompatActivity implements OnFridgeItemInteractionListener {
    ...
    private void updateBeerList(List<Pair<BeerInFridge, Beer>> entries) {
    ...
    @Override
    public void onBeerInFridgeClickedListener(Beer beer, String amount) {
        model.setUserFridgeItemAmount(beer.getId(), amount);
    }
}
